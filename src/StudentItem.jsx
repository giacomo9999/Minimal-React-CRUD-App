  ...
  render() {
    ...
    return this.state.isEdit === true ? (
      <tr className="bg-warning" key={this.props.index}>
        ...
        <td>
          <i className="far fa-save" onClick={this.editStudentSubmit} />
        </td>
        <td>
      ...
      <tr key={this.props.index}>
        ...
        <td>{school}</td>
        <td>
          <i className="far fa-edit" onClick={this.editStudent} />
        </td>
        <td>
          <i className="fas fa-trash" onClick={this.deleteStudent} />
        </td>
      </tr>
    );
  }
